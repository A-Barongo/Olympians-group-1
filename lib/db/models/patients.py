...
# Class methods for CRUD operations 
   ...
   @classmethod
   def get_by_id(cls, session: Session, patient_id: int):
...
# Class method to create a new patient
   ...
   @classmethod
   def create_patient(cls, session: Session, name: str, date_of_birth: date, gender: GenderEnum, email: str, status: StatusEnum,current_medication: str = None, chronic_conditions: str = None):
       new_patient = cls(
           name=name,
